...
-- Sell picked crops to a vendor (Grapeseed area by default; change coords to match your server)
Config.FarmersMarket = {
    enabled = true,
    payAccount = 'cash', -- qb money account: cash, bank, etc.
    sellZoneRadius = 4.0,
    blip = {
        enabled = true,
        sprite = 52,
    ...
    ped = {
        ...
        coords = vec4(2006.51, 4984.00, 40.37, 328.62),
        scenario = 'WORLD_HUMAN_STAND_IMPATIENT',
    },
    -- Price per unit sold to the vendor (set to 0 to disallow selling that item here)
    prices = {
        apple = 12,
        orange = 10,
        lime = 11,
